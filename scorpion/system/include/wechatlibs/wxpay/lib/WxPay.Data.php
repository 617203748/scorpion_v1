...
class WxPayResults extends WxPayDataBase
{
	...
	public function CheckSign()
	{
        ...
        //Logs::DEBUG(" makesign--  " .$sign);

        //Logs::DEBUG(" getsign -- " .$this->GetSign());
	...
	{	
        ...
        Logs::DEBUG(" obj " .json_encode($obj));
		...
		//薛莹添加的
		//WxPayConfig::$APPID=$obj->values['appid'];
		//WxPayConfig::$MCHID=$obj->values['MCHID'];
